...
func withTestTransaction(t *testing.T, testFunc func(ctx context.Context, repo *repositories.UserRepositoryPostgre, tx ports.Transaction)) {
	...
	repo := &repositories.UserRepositoryPostgre{DB: db}
